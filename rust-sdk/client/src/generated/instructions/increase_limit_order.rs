...
pub const INCREASE_LIMIT_ORDER_DISCRIMINATOR: [u8; 8] = [177, 144, 89, 236, 250, 186, 125, 99];
...
impl IncreaseLimitOrder {
  pub fn instruction(&self, args: IncreaseLimitOrderInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: IncreaseLimitOrderInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&IncreaseLimitOrderInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct IncreaseLimitOrderInstructionData {
            discriminator: [u8; 8],
                  }

impl IncreaseLimitOrderInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [177, 144, 89, 236, 250, 186, 125, 99],
                                              }
  }
}

impl Default for IncreaseLimitOrderInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct IncreaseLimitOrderInstructionArgs {
                  pub amount: u64,
...
///
          ...
          ///   4. `[]` token_mint
                ///   5. `[writable]` token_owner_account
                ///   6. `[writable]` token_vault
                ///   7. `[writable]` tick_array
                ///   8. `[optional]` token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
          ///   9. `[]` memo_program
#[derive(Clone, Debug, Default)]
pub struct IncreaseLimitOrderBuilder {
            limit_order_authority: Option<solana_pubkey::Pubkey>,
                ...
                token_owner_account: Option<solana_pubkey::Pubkey>,
...
impl IncreaseLimitOrderBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
    ...
    pub fn token_mint(&mut self, token_mint: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn token_owner_account(&mut self, token_owner_account: solana_pubkey::Pubkey) -> &mut Self {
                        self.token_owner_account = Some(token_owner_account);
                    self
    }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = IncreaseLimitOrder {
                              limit_order_authority: self.limit_order_authority.expect("limit_order_authority is not set"),
                                        ...
                                        token_owner_account: self.token_owner_account.expect("token_owner_account is not set"),
          ...
          let args = IncreaseLimitOrderInstructionArgs {
  ...
  pub struct IncreaseLimitOrderCpiAccounts<'a, 'b> {
              ...
              pub token_owner_account: &'b solana_account_info::AccountInfo<'a>,
...
impl<'a, 'b> IncreaseLimitOrderCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: IncreaseLimitOrderCpiAccounts<'a, 'b>,
              args: IncreaseLimitOrderInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
              ...
              token_owner_account: accounts.token_owner_account,
  ...
  pub fn invoke_signed_with_remaining_accounts(
    ...
    account_infos.push(self.__program.clone());
                  account_infos.push(self.limit_order_authority.clone());
                        ...
                        account_infos.push(self.token_owner_account.clone());
...
///
          ...
          ///   9. `[]` memo_program
#[derive(Clone, Debug)]
pub struct IncreaseLimitOrderCpiBuilder<'a, 'b> {
  instruction: Box<IncreaseLimitOrderCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> IncreaseLimitOrderCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(IncreaseLimitOrderCpiBuilderInstruction {
      __program: program,
    ...
    pub fn token_mint(&mut self, token_mint: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn token_owner_account(&mut self, token_owner_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.token_owner_account = Some(token_owner_account);
                    self
    }
      #[inline(always)]
    pub fn token_vault(&mut self, token_vault: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = IncreaseLimitOrderCpi {
        __program: self.instruction.__program,
          ...
          token_owner_account: self.instruction.token_owner_account.expect("token_owner_account is not set"),
...
#[derive(Clone, Debug)]
struct IncreaseLimitOrderCpiBuilderInstruction<'a, 'b> {
  __program: &'b solana_account_info::AccountInfo<'a>,
            limit_order_authority: Option<&'b solana_account_info::AccountInfo<'a>>,
                ...
                token_owner_account: Option<&'b solana_account_info::AccountInfo<'a>>,
