...
pub const SET_CLP_REWARD_RATE_DISCRIMINATOR: [u8; 8] = [76, 80, 236, 123, 252, 215, 183, 23];

/// Accounts.
#[derive(Debug)]
pub struct SetClpRewardRate {
...
impl SetClpRewardRate {
  pub fn instruction(&self, args: SetClpRewardRateInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetClpRewardRateInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&SetClpRewardRateInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SetClpRewardRateInstructionData {
            discriminator: [u8; 8],
            }

impl SetClpRewardRateInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [76, 80, 236, 123, 252, 215, 183, 23],
                                }
  }
}

impl Default for SetClpRewardRateInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SetClpRewardRateInstructionArgs {
...
pub struct SetClpRewardRateBuilder {
...
impl SetClpRewardRateBuilder {
  pub fn new() -> Self {
    ...
    pub fn fee_authority(&mut self, fee_authority: solana_pubkey::Pubkey) -> &mut Self {
      ...
      pub fn clp_reward_rate(&mut self, clp_reward_rate: u16) -> &mut Self {
        self.clp_reward_rate = Some(clp_reward_rate);
        self
      }
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = SetClpRewardRate {
          ...
          let args = SetClpRewardRateInstructionArgs {
                                                              clp_reward_rate: self.clp_reward_rate.clone().expect("clp_reward_rate is not set"),
                                    };
  ...
  pub struct SetClpRewardRateCpiAccounts<'a, 'b> {
...
pub struct SetClpRewardRateCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: SetClpRewardRateInstructionArgs,
  }

impl<'a, 'b> SetClpRewardRateCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: SetClpRewardRateCpiAccounts<'a, 'b>,
              args: SetClpRewardRateInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
///
          ///   0. `[]` fusion_pools_config
                ...
                ///   2. `[signer]` fee_authority
#[derive(Clone, Debug)]
pub struct SetClpRewardRateCpiBuilder<'a, 'b> {
  instruction: Box<SetClpRewardRateCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetClpRewardRateCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(SetClpRewardRateCpiBuilderInstruction {
      __program: program,
              fusion_pools_config: None,
              fusion_pool: None,
              fee_authority: None,
                                            clp_reward_rate: None,
    ...
    pub fn fee_authority(&mut self, fee_authority: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn clp_reward_rate(&mut self, clp_reward_rate: u16) -> &mut Self {
        self.instruction.clp_reward_rate = Some(clp_reward_rate);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = SetClpRewardRateInstructionArgs {
                                                              clp_reward_rate: self.instruction.clp_reward_rate.clone().expect("clp_reward_rate is not set"),
                                    };
        let instruction = SetClpRewardRateCpi {
...
#[derive(Clone, Debug)]
struct SetClpRewardRateCpiBuilderInstruction<'a, 'b> {
