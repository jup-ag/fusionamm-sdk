...
pub const INITIALIZE_SPARSE_TICK_ARRAY_DISCRIMINATOR: [u8; 8] = [53, 5, 112, 210, 93, 239, 122, 150];

/// Accounts.
#[derive(Debug)]
pub struct InitializeSparseTickArray {
...
impl InitializeSparseTickArray {
  pub fn instruction(&self, args: InitializeSparseTickArrayInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitializeSparseTickArrayInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&InitializeSparseTickArrayInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct InitializeSparseTickArrayInstructionData {
            discriminator: [u8; 8],
            }

impl InitializeSparseTickArrayInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [53, 5, 112, 210, 93, 239, 122, 150],
                                }
  }
}

impl Default for InitializeSparseTickArrayInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct InitializeSparseTickArrayInstructionArgs {
                  pub start_tick_index: i32,
      }


/// Instruction builder for `InitializeSparseTickArray`.
///
/// ### Accounts:
///
          ///   0. `[]` fusion_pool
...
pub struct InitializeSparseTickArrayBuilder {
...
impl InitializeSparseTickArrayBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = InitializeSparseTickArray {
          ...
          let args = InitializeSparseTickArrayInstructionArgs {
  ...
  /// `initialize_sparse_tick_array` CPI accounts.
  pub struct InitializeSparseTickArrayCpiAccounts<'a, 'b> {
...
/// `initialize_sparse_tick_array` CPI instruction.
pub struct InitializeSparseTickArrayCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: InitializeSparseTickArrayInstructionArgs,
  }

impl<'a, 'b> InitializeSparseTickArrayCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: InitializeSparseTickArrayCpiAccounts<'a, 'b>,
              args: InitializeSparseTickArrayInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `InitializeSparseTickArray` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` fusion_pool
          ...
          ///   3. `[]` system_program
#[derive(Clone, Debug)]
pub struct InitializeSparseTickArrayCpiBuilder<'a, 'b> {
  instruction: Box<InitializeSparseTickArrayCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InitializeSparseTickArrayCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(InitializeSparseTickArrayCpiBuilderInstruction {
      __program: program,
              fusion_pool: None,
              funder: None,
              tick_array: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = InitializeSparseTickArrayCpi {
...
#[derive(Clone, Debug)]
struct InitializeSparseTickArrayCpiBuilderInstruction<'a, 'b> {
