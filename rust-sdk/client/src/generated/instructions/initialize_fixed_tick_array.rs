...
pub const INITIALIZE_FIXED_TICK_ARRAY_DISCRIMINATOR: [u8; 8] = [73, 14, 85, 59, 113, 83, 209, 107];

/// Accounts.
#[derive(Debug)]
pub struct InitializeFixedTickArray {
...
impl InitializeFixedTickArray {
  pub fn instruction(&self, args: InitializeFixedTickArrayInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitializeFixedTickArrayInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&InitializeFixedTickArrayInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct InitializeFixedTickArrayInstructionData {
            discriminator: [u8; 8],
            }

impl InitializeFixedTickArrayInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [73, 14, 85, 59, 113, 83, 209, 107],
                                }
  }
}

impl Default for InitializeFixedTickArrayInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct InitializeFixedTickArrayInstructionArgs {
                  pub start_tick_index: i32,
      }


/// Instruction builder for `InitializeFixedTickArray`.
///
/// ### Accounts:
///
          ///   0. `[]` fusion_pool
...
pub struct InitializeFixedTickArrayBuilder {
...
impl InitializeFixedTickArrayBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = InitializeFixedTickArray {
          ...
          let args = InitializeFixedTickArrayInstructionArgs {
  ...
  /// `initialize_fixed_tick_array` CPI accounts.
  pub struct InitializeFixedTickArrayCpiAccounts<'a, 'b> {
...
/// `initialize_fixed_tick_array` CPI instruction.
pub struct InitializeFixedTickArrayCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: InitializeFixedTickArrayInstructionArgs,
  }

impl<'a, 'b> InitializeFixedTickArrayCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: InitializeFixedTickArrayCpiAccounts<'a, 'b>,
              args: InitializeFixedTickArrayInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `InitializeFixedTickArray` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` fusion_pool
          ...
          ///   3. `[]` system_program
#[derive(Clone, Debug)]
pub struct InitializeFixedTickArrayCpiBuilder<'a, 'b> {
  instruction: Box<InitializeFixedTickArrayCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InitializeFixedTickArrayCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(InitializeFixedTickArrayCpiBuilderInstruction {
      __program: program,
              fusion_pool: None,
              funder: None,
              tick_array: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = InitializeFixedTickArrayCpi {
...
#[derive(Clone, Debug)]
struct InitializeFixedTickArrayCpiBuilderInstruction<'a, 'b> {
