...
pub const SET_DEFAULT_ORDER_PROTOCOL_FEE_RATE_DISCRIMINATOR: [u8; 8] = [60, 183, 119, 187, 211, 51, 66, 236];
...
impl SetDefaultOrderProtocolFeeRate {
  pub fn instruction(&self, args: SetDefaultOrderProtocolFeeRateInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetDefaultOrderProtocolFeeRateInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&SetDefaultOrderProtocolFeeRateInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SetDefaultOrderProtocolFeeRateInstructionData {
            discriminator: [u8; 8],
            }

impl SetDefaultOrderProtocolFeeRateInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [60, 183, 119, 187, 211, 51, 66, 236],
                                }
  }
}

impl Default for SetDefaultOrderProtocolFeeRateInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SetDefaultOrderProtocolFeeRateInstructionArgs {
...
pub struct SetDefaultOrderProtocolFeeRateBuilder {
...
impl SetDefaultOrderProtocolFeeRateBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = SetDefaultOrderProtocolFeeRate {
          ...
          let args = SetDefaultOrderProtocolFeeRateInstructionArgs {
...
pub struct SetDefaultOrderProtocolFeeRateCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: SetDefaultOrderProtocolFeeRateInstructionArgs,
  }

impl<'a, 'b> SetDefaultOrderProtocolFeeRateCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: SetDefaultOrderProtocolFeeRateCpiAccounts<'a, 'b>,
              args: SetDefaultOrderProtocolFeeRateInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
///
                ...
                ///   1. `[signer]` fee_authority
#[derive(Clone, Debug)]
pub struct SetDefaultOrderProtocolFeeRateCpiBuilder<'a, 'b> {
  instruction: Box<SetDefaultOrderProtocolFeeRateCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetDefaultOrderProtocolFeeRateCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(SetDefaultOrderProtocolFeeRateCpiBuilderInstruction {
      __program: program,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = SetDefaultOrderProtocolFeeRateCpi {
...
#[derive(Clone, Debug)]
struct SetDefaultOrderProtocolFeeRateCpiBuilderInstruction<'a, 'b> {
