...
impl CollectFees {
  pub fn instruction(&self, args: CollectFeesInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CollectFeesInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&CollectFeesInstructionData::new()).unwrap();
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CollectFeesInstructionArgs {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = CollectFees {
          ...
          let args = CollectFeesInstructionArgs {
...
pub struct CollectFeesCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: CollectFeesInstructionArgs,
  }
  ...
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: CollectFeesCpiAccounts<'a, 'b>,
              args: CollectFeesInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
