...
//!
  ...
  pub(crate) mod r#set_clp_reward_rate;
  pub(crate) mod r#set_collect_protocol_fees_authority;
  pub(crate) mod r#set_default_clp_reward_rate;
  pub(crate) mod r#set_default_order_protocol_fee_rate;
  pub(crate) mod r#set_default_protocol_fee_rate;
  pub(crate) mod r#set_fee_authority;
  pub(crate) mod r#set_fee_rate;
  pub(crate) mod r#set_order_protocol_fee_rate;
  ...
  pub use self::r#set_clp_reward_rate::*;
  pub use self::r#set_collect_protocol_fees_authority::*;
  pub use self::r#set_default_clp_reward_rate::*;
  pub use self::r#set_default_order_protocol_fee_rate::*;
  pub use self::r#set_default_protocol_fee_rate::*;
  pub use self::r#set_fee_authority::*;
  pub use self::r#set_fee_rate::*;
  pub use self::r#set_order_protocol_fee_rate::*;
